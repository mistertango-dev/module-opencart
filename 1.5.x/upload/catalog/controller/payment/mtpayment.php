...
class ControllerPaymentMTPayment extends Controller
{
    ...
    public function index()
    {
        ...
        $this->data['mtpayment_url_confirm'] = $this->url->link('payment/mtpayment/confirm');
        $this->data['mtpayment_url_history'] = $this->url->link('payment/mtpayment/history');
    ...
    public function history()
    {
        ...
        $this->data['mtpayment_url_confirm'] = $this->url->link('payment/mtpayment/confirm');
        $this->data['mtpayment_url_history'] = $this->url->link('payment/mtpayment/history');
        $this->data['mtpayment_url_histories'] = $this->url->link('payment/mtpayment/histories');
